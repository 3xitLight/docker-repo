...
/* Define if gio-unix-2.0 >= 2.30.0 present */
#define HAVE_GIO_UNIX 1

/* Define to 1 if you have the <grp.h> header file. */
#define HAVE_GRP_H 1

/* Define if gstreamer-${with_gstreamer} >= ${with_gstreamer} present */
...
#define PACKAGE_STRING "Thunar 1.6.16"
